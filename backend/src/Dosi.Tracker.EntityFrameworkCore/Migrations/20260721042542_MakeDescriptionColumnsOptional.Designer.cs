...
namespace Dosi.Tracker.Migrations
{
    ...
    [Migration("20260721042542_MakeDescriptionColumnsOptional")]
    partial class MakeDescriptionColumnsOptional
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dosi.Tracker.Activities.Activity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");

                    b.Property<string>("ActiveWindowsJson")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<Guid>("ClientActivityId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("RunningProgramsJson")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("TenantId", "ClientActivityId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Dosi.Tracker.Activities.Screenshot", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppScreenshots", (string)null);
                });

            modelBuilder.Entity("Dosi.Tracker.Billing.Invoice", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dosi.Tracker.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dosi.Tracker.Projects.Project", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dosi.Tracker.Projects.ProjectMember", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dosi.Tracker.SaaS.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dosi.Tracker.SaaS.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Dosi.Tracker.Activities.Screenshot", b =>
                {
                    b.HasOne("Dosi.Tracker.Activities.Activity", null)
                        .WithOne("Screenshot")
                        .HasForeignKey("Dosi.Tracker.Activities.Screenshot", "ActivityId")
            ...
            modelBuilder.Entity("Dosi.Tracker.Projects.ProjectMember", b =>
                {
                    b.HasOne("Dosi.Tracker.Projects.Project", null)
                        .WithMany("Members")
