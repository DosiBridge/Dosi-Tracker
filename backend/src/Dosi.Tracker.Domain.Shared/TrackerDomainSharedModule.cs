...
public class TrackerDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        TrackerGlobalFeatureConfigurator.Configure();
        TrackerModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<TrackerDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<TrackerResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/Tracker");

            options.DefaultResourceType = typeof(TrackerResource);
        ...
        {
            options.MapCodeNamespace("Tracker", typeof(TrackerResource));
        });
    }
}
